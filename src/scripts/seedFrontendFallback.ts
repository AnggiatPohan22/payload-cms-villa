...
const main = async () => {
  ...
  await payload.updateGlobal({
    ...
    data: {
      hero: {
        ...
        image: await ensureMedia(payload, '/assets/img/services-3.webp', `${property.name} services page hero`, 'hero'),
      ...
      finalCTA: {
        ...
        secondary: {
          ...
          url: `https://wa.me/${property.whatsapp}`,
          openInNewTab: true,
        },
        active: true,
        sortOrder: 5,
  ...
  await payload.updateGlobal({
    ...
    data: {
      hero: {
        sectionName: 'Hero',
        heading: 'Contact Villa Ceningan',
        description: 'Talk directly with the Villa Ceningan team for stay inquiries and island guidance.',
        image: heroImage,
        active: true,
        sortOrder: 1,
      },
      contactInquiry: {
        ...
        button: { label: 'Chat on WhatsApp', url: `https://wa.me/${property.whatsapp}`, openInNewTab: true },
        phone: property.phone,
        email: property.email,
        whatsApp: property.whatsapp,
        address: property.address,
      ...
      mapSection: {
        ...
        description: 'Set in the rhythm of Nusa Ceningan, close enough to island life and quiet enough to fully slow down.',
        locationHeading: property.address,
        mapTitle: `${property.name} map`,
        mapEmbedURL: property.mapEmbedUrl,
        button: { label: 'Get Directions', url: `https://wa.me/${property.whatsapp}`, openInNewTab: true },
        active: true,
        sortOrder: 4,
      },
      quote: {
